...
- App EXE 与托盘直接使用选定的 Agent Matrix 概念图：横向外框表示 75% 键盘，中央四个互锁模块
  表示 Codex 代理协作，右侧灯条表示 Kick75 侧灯。生成脚本从概念图提取透明的黑线 App 版本
  和白线托盘版本，并输出 16–256 px ICO；栅格母版和多尺寸 ICO 位于
